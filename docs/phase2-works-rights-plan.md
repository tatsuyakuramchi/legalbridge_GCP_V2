...
| 2-3 | 作品編集の拡張（現行5列→kind/derivation/parent/rights_holder等）＋系譜編集 | 書込 | 012（works UPDATE・適用済想定）＋work_relations書込は新規 | 未 |
| 2-4 | 権利ソース(material_rights_sources) 読取詳細＋capability-gated書込 | 書込 | 新規 | 未 |
