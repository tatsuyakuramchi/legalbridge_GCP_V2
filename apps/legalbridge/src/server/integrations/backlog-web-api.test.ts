...
test("課題一覧はprojectIdを解決してGETし、要点を整形する", async () => {
  ...
  const client = new BacklogWebApiClient({
    ...
    fetch: async (input) => {
      ...
      return new Response(JSON.stringify([
        { id: 1, issueKey: "LEGAL-1", summary: "NDA確認", status: { name: "未対応" }, assignee: { name: "田中" }, created: "2026-08-01T00:00:00Z", updated: "2026-08-02T00:00:00Z" },
  ...
  assert.deepEqual(issues[0], { id: 1, issueKey: "LEGAL-1", summary: "NDA確認", statusName: "未対応", assigneeName: "田中", created: "2026-08-01T00:00:00Z", updated: "2026-08-02T00:00:00Z" });
